      ...
      <div className="flex flex-col md:flex-row w-full max-w-4xl bg-white rounded-[40px] overflow-hidden shadow-2xl min-h-[550px]">
        ...
        <div className="hidden md:flex flex-col justify-between w-1/2 p-12 bg-white">
          <div className="flex items-center gap-2">
            ...
            <div className="w-7 h-7 bg-[#234d40] rounded flex items-center justify-center text-white text-xs font-bold">R</div>
            <span className="text-black font-bold tracking-tight">RECRUTEPRO</span>
          </div>
          ...
          <div className="flex flex-col items-center">
             <div className="w-64 h-64 bg-gray-50 rounded-full flex items-center justify-center border-2 border-dashed border-gray-200">
                <span className="text-gray-300 italic font-medium">Illustration</span>
             </div>
          </div>
        ...
        <div className="w-full md:w-1/2 px-12 py-16 flex flex-col justify-center bg-[#234d40] text-white">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="text-right">
                <a href="#" className="text-xs text-gray-400 hover:text-white underline-offset-2 hover:underline">Mot de passe oublié ?</a>
              </div>
            </div>
          ...
          <div className="mt-10 text-center text-sm text-gray-300">
            ...
            <a href="#" className="text-white font-bold hover:underline">S'inscrire maintenant</a>
          </div>
        </div>
